  ...
  return <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow bg-green-50">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
          ...
          {featuredEvents.length > 0 && <motion.section className="mb-16" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          duration: 0.6
              ...
              <motion.h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-green-800" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            delay: 0.2
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <AnimatePresence>
                  {featuredEvents.map((event, index) => <motion.div key={event.id} initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                delay: index * 0.1
                      ...
                      <EnhancedEventCard event={event} onRegister={handleRegister} variant="featured" />
                    </motion.div>)}
                </AnimatePresence>
              </div>
            </motion.section>}
          ...
          delay: 0.3
            ...
            {upcomingEvents.length === 0 ? <motion.div className="text-center py-12" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            delay: 0.6
                ...
                delay: index * 0.05
              }} layout className="mx-[2px] my-[2px] px-0 py-px">
                      <EnhancedEventCard event={event} onRegister={handleRegister} variant="standard" />
                    </motion.div>)}
                </AnimatePresence>
              </div>}
            ...
            delay: 0.8
              ...
              <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-8 rounded-2xl text-center border border-primary/20">
                <motion.div className="text-3xl mb-4" animate={{
                rotate: [0, 10, -10, 0],
                scale: [1, 1.1, 1]
              }} transition={{
                duration: 2,
      ...
      {/* Registration Dialog */}
      <EventRegistrationDialog event={selectedEvent} isOpen={isRegistrationOpen} onClose={handleCloseRegistration} />
    </div>;
};
