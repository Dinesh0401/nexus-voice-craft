...
const EnhancedRecentPosts = () => {
  ...
  return <section className="py-20 px-4 md:px-8 bg-gradient-to-br from-background to-ai-surface/10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {posts.map((post, index) => <motion.div key={post.id} className="group relative" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          duration: 0.6
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-background to-ai-surface shadow-ai-soft border border-ai-border hover:shadow-ai-glow transition-all duration-500 group-hover:scale-[1.02]">
                {/* AI Badge */}
                {post.aiGenerated && <div className="absolute top-4 left-4 z-10">
                ...
                <div className="relative h-64 overflow-hidden">
                  <motion.img src={post.image} alt={post.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" initial={{
                opacity: 0
              }} animate={{
                opacity: 1
              }} transition={{
                ...
                {/* Content */}
                <div className="p-8">
                  {post.category && <Badge variant="secondary" className="mb-3 bg-ai-accent/20 text-ai-primary border-ai-border">
                      {post.category}
                    </Badge>}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button variant="ghost" className="text-ai-primary hover:text-ai-secondary hover:bg-ai-surface group-hover:translate-x-1 transition-all duration-300" onClick={() => handleReadMore(post.id)}>
                      Read more
        ...
        duration: 0.6
          ...
          <Button onClick={handleViewAllArticles} className="bg-gradient-to-r from-ai-primary to-ai-secondary hover:from-ai-primary/90 hover:to-ai-secondary/90 text-white px-8 py-3 shadow-ai-glow">
            View all articles
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </motion.div>
